"""
Django settings for GAPA project.
...
SECRET_KEY = 'django-insecure-ocubk+z5thi1f-33+m1$zb&7((x!tx$2-!_h)yn&dkswlyt6j$'
...
WSGI_APPLICATION = 'GAPA.wsgi.application'
